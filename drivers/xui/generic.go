...
func (d *generic) Login(ctx context.Context) error {
	...
	if b, ok := d.sp.Auth.(core.BasicAuth); ok {
		body["username"], body["password"] = b.Username, b.Password
	}
...
func (d *generic) ListUsers(ctx context.Context) ([]core.User, error) {
	...
	for _, r := range rows {
		...
		if v := pickInt64Ptr(r, "expire", "expire_at"); v != nil {
			u.ExpireAt = v
		}
		if v := firstNonNilInt64Ptr(sumFields(r, []string{"up", "down"}), pickInt64Ptr(r, "traffic_used")); v != nil {
			u.TrafficUsed = v
		}
		if u.ID == "" {
			u.ID = u.Username
...
func (d *generic) CreateUser(ctx context.Context, u core.User) (core.User, error) {
	return u, core.ErrNotImplemented
}
func (d *generic) UpdateUser(ctx context.Context, u core.User) (core.User, error) {
	return u, core.ErrNotImplemented
}
...
func (d *generic) ResetUserTraffic(ctx context.Context, id string) error {
	return core.ErrNotImplemented
}
func (d *generic) CreateInbound(ctx context.Context, in core.Inbound) (core.Inbound, error) {
	return in, core.ErrNotImplemented
}
func (d *generic) UpdateInbound(ctx context.Context, in core.Inbound) (core.Inbound, error) {
	return in, core.ErrNotImplemented
}
